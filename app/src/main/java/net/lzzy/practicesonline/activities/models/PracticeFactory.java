...
public class PracticeFactory {
    ...
    public void saveQuestions(List<Question> questions, UUID pacticeId) {
        for (Question q : questions) {
            QuestionFactory.getInstance().insert(q);
        }
        setPracticeDown(pacticeId.toString());
    }

    public boolean deletePracticeAnRelated(Practice practice) {
        try {
